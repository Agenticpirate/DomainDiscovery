...
export function RegistrarActionMenu({
  ...
  const handleFallbackClick = () => {
    const nextUrl = premiumUrl || `https://who.is/whois/${encodeURIComponent(domain)}`;
          ...
          {REGISTRARS.map((registrar) => (
            ...
            >
              ...
              <span className="flex items-center gap-2">
                ...
                <svg className={cn('h-3.5 w-3.5 shrink-0', isLight ? 'text-slate-300' : 'text-white/20')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
