...
const iconCls = (className?: string) => className || 'w-5 h-5';

export const Icons = {
  Search: ({ className }: IconProps = {}) => (
    <svg className={iconCls(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  Layers: ({ className }: IconProps = {}) => (
    <svg className={iconCls(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M4 7l8-4 8 4-8 4-8-4zM4 12l8 4 8-4M4 17l8 4 8-4" />
    </svg>
  ),
  Bulk: ({ className }: IconProps = {}) => (
    <svg className={iconCls(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
