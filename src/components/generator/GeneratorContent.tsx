...
export const GeneratorContent: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      question: 'How does the DomainsDiscovery generator work?',
    ...
    <div className="space-y-16 py-16">
      ...
      <section className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg">
              3
            </div>
            <div>
          ...
          <div className="flex gap-6 items-start">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-bold text-lg">
              4
            </div>
            <div>
