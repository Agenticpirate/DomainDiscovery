...
export default function DomainExtensionsPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Main Content */}
      <main className="relative pt-18 sm:pt-22">
        {/* Hero Section */}
        <section className="px-4 sm:px-6 pb-4 sm:pb-5">
          <div className="max-w-7xl mx-auto">
            <Breadcrumb items={[
              { label: 'Search', href: '/' },
              { label: 'Domain Extensions' }
            ]} />
            <h1 className="text-3xl sm:text-5xl md:text-[3.6rem] font-black tracking-tight mb-2">
            ...
            <p className={`text-sm sm:text-[15px] ${isLight ? 'text-slate-500' : 'text-white/50'} max-w-2xl mb-4 sm:mb-5`}>
